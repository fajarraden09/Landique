...
$admins = mysqli_query($conn, "SELECT * FROM tb_admins WHERE adminsid = '$id'");
...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="assets/images/webgis.jpg" type="image/jpeg"/>
      ...
      <div class="left side-menu">
        ...
        <div class="topbar-left">
          <div class="text-center">
            <a href="index.php"><img src="assets/images/logo.png" width="160px"></a>
          </div>
        </div>
            ...
            <nav class="navbar-custom">
              <ul class="list-inline float-right mb-0">
                <li class="list-inline-item dropdown notification-list">
                  ...
                  <?php if(!empty($tampiladmins['adminsfoto'])) { ?>
                    <img
                      src="fotoadmins/<?= $tampiladmins['adminsfoto']; ?>";
                      alt="user"
                      class="rounded-circle"
                    />
                  <?php }else{ ?>
                    <img
                      src="fotoadmins/default.svg";
                      alt="user"
                      class="rounded-circle"
                    />
                  <?php } ?>
                  ...
                  >
                    ...
                    <div class="dropdown-item noti-title">
                      <h5>Welcome Admin <?= $tampiladmins['Level']; ?>
                    </h5>
                    </div>
