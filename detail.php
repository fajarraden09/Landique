              ...
              ?>    
					...
					<div class="col-md-5 col-md-pull-1">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">Rp <?= number_format($tampil['harga']); ?></h3>
								<span class="product-available">Stok : <?php echo $tampil['stok']; ?></span>
							</div>
							<p style="text-align:justify;"><?php echo $tampil['deskripsi']; ?></p>
                <div class="add-to-cart">
                  <a href="form_bayar.php?id=<?php echo $tampil['id_produk'];?>">
                    <button class="add-to-cart-btn" type="submit">
                    <i class="fa fa-money"></i> Checkout</button>
                  </a>
                </div>
						</div>
					</div>
