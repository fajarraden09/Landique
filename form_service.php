            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="product" class="form-control" placeholder="Nama Alat" id="product">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button class="btn btn-success send">Kirim -> WhatsApp</button>
                    </div>
...
<script>
   $(document).on('click','.send', function(){
    ...
    var walink      = 'https://web.whatsapp.com/send',
        phone       = '6281225061527',
        text        = 'Halo saya ingin anda memperbaiki alat saya.. ',
    ...
    if(input_name != "" && input_phone != "" && input_product != ""){
        ...
        var checkout_whatsapp = walink + '?phone=' + phone + '&text=' + text + '%0A%0A' +
            ...
            '*Nama Alat*         : ' + input_product + '%0A' +
            '*Alamat Servis*    : ' + input_address + '%0A';
